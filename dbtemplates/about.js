...
if (dbChoice == 'mongoose') {
	...
	/*
		Most of the fields for about pages are self explanatory except for
		sectionBlocks. sectionBlocks, represents an array of content blocks
		for the page.

		Each content block has a type field identifying which of the following
		content block formats it follows:

		Type 0: Welled content blocks
		{
			type: 0,
			mainHeader: String,
			blocks: [{
		...
		Type 1: Profile banners (good for sponsorship and teams)
		{
			type: 1,
